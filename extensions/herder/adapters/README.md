...
- only for Implementers, Ponytail's exact `pi-extension/index.js` from Pi's trusted user Git store; Reviewer and Judge sessions remain extension-free, with no ambient/project discovery or extension skills, prompts, or themes;
