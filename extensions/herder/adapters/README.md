...
Active-Fire plan editing is a user-facing command contract; see the package README's [canonical planning and execution command reference](../README.md#planning-and-execution-commands). The adapter implements the reservation and revision barrier described there.
