...
test("Pi and planning commands share one direct application facade", () => {
	...
	assert.match(application, /export function invokeHerderTool\(name: "herder_plan" \| "herder_run" \| "herder_verification" \| "herder_integration_repair" \| "herder_reignite", args: JsonObject\)/);
	...
	assert.match(application, /export async function submitHerderEvent/);
