...
import { HerderRunManager, type EventInput, type PlanEditInput, type ReigniteInput, type StartInput } from "../core/run-manager.ts";
...
export interface ManagerWorkerCall {
	id: number;
	method: "reply" | "start" | "event" | "edit" | "stop" | "verification" | "reignite" | "auditScheduler" | "dashboardState";
	input?: unknown;
}
