...
import type { ServiceTierInput } from "./service-tier.js";
...
export const DEFAULT_AGENT_NAMES = ["recon", "worker", "reviewer"] as const;
...
export interface AgentConfig {
  ...
  /** OpenAI-style service tier: fast|standard (or priority|default|flex|auto). */
